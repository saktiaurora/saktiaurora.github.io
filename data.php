  ...
  <body id="page-top">
    ...
    <div class="jumbotron">
      <div class="container">
          ...
          <div class="alert alert-warning" role="alert">
            ...
            <div class="container">
              <div class="row">
                <div class="col-sm">
                  <table class="table table-striped">
                    <tbody>
                      ...
                      <tr>
                        <th scope="row">My place and date of birth</th>
                        <td>:</td>
                        <td>Padang panjang, 21 August 1998</td>
                      </tr>
                      <tr>
                        <th scope="row">Email</th>
                        <td>:</td>
                        <td>aimran9808@gmail.com</td>
                      </tr>
                      <tr>
                ...
                <div class="col-sm">
                  <figure class="figure">
                    <img src="img/marapi.jpeg" class="figure-img img-fluid rounded" alt="img/marapi.jpeg">
                    <figcaption class="figure-caption">My Journey</figcaption>
                  </figure>
                </div>
              </div>
            </div>
          ...
          <a class="btn btn-primary btn-lg font-weight-bold" href="index.html" role="button">Home</a>
      </div>
    </div>
